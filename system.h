...
#define ACTIV_INTER_UART2_TX            1   // UART AX12 : Acquittement trame envoy�e
...
/******************************************************************************/
    ...
    /**
     * Toutes les variables appell�es par la le timer d'asserv de 5 ms
     * sont d�finies en near 
     * Elles sont ainsi stock�e dans la m�moire de 8 ko proche du cpu
     * et on y acc�de plus rapidement
     */
    
    /**
     * Toutes les variables dont la valeurs est succeptibles d'�tre modifi�e
     * dans une interruption doivent �tre d�clar�e volatile !
     */
...
/******************************************************************************/
    ...
    /**
     * Fonction qui initialise le compteur de temps de match � z�ro
     */
   ...
   /**
    * Configuration du Timer de 10 ms pour l'�vitement
    *        /!\  ATTENTION : TIMER SAFE   /!\
    * /!\ INTERDICTION D'UTILISER DES FONCTIONS BLOQUANTES /!\
    * /!\ OU DE DESACTIVER LE DECOMPTE DU TIMER PENDANT   /!\
